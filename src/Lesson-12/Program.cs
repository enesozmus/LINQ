...
#region Using Anonymous Type for Union Operation
...
var MS = studentList1
            ...
            .Union(studentList2.Select(x => new { x.StudentID, x.StudentName, x.Age }));
...
#region Using IEqualityComparer with Union
IEnumerable<Student>? resultedCol = studentList1
                                        .Union(studentList2, new StudentComparer());
